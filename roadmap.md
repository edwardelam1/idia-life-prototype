...
- [ ] Biometric consent deadlock fix: timeout + dual-channel result in acaGenerator
- [ ] Phase watchdog + foreground re-check + success reconciliation in AppleHealthModal
- [ ] DataDashboard: connected requires is_active=true; single delete-based disconnect path
- [ ] Hide Life & Shop tabs + spotlight tour until 2026-12-31

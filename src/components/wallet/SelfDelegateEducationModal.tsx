...
const SelfDelegateEducationModal = ({ isVisible, onDismiss, onGoToWallet }: SelfDelegateEducationModalProps) => {
  ...
  const handleGoToWallet = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    onGoToWallet?.();
    onDismiss();
      ...
      >
        ...
        <div className="p-6 bg-gradient-to-br from-[hsl(178,42%,32%)] to-[hsl(35,92%,52%)] text-white">
          ...
          <p className="text-xs text-white/90 leading-relaxed">
            You've just added a wallet! To obtain governance power of the IDIA Protocol you need a small amount of
            crypto to Self-Delegate.
          </p>
        </div>
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center gap-2 p-3 rounded-xl bg-teal-50 border border-teal-100">
              ...
              <div className="min-w-0">
                <p className="text-[10px] uppercase tracking-wider text-teal-700/70 font-bold">Required</p>
            ...
            <div className="flex items-center gap-2 p-3 rounded-xl bg-amber-50 border border-amber-100">
              ...
              <div className="min-w-0">
                <p className="text-[10px] uppercase tracking-wider text-amber-700/70 font-bold">Gas (Base)</p>
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            <strong className="text-slate-800">Self-Delegating</strong> is how you Claim Your Voice in the IDIA
            Protocol. Pressing the "Self-Delegate" button after you have the necessary crypto assigns your voting weight
            to your wallet.
          </p>

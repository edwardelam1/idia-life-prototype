...
const AndroidHealthModal = ({
  isOpen,
  onClose,
  onComplete,
  existingConnection,
  onDisconnect,
}: AndroidHealthModalProps) => {
    ...
    try {
      await supabase
        ...
        .upsert(
          {
            user_id: userId,
            connection_type: "health_connect",
            connection_name: "Health Connect",
            is_active: true,
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-2">
            ...
            <span>{existingConnection ? "Health Connect" : "Connect Health Connect"}</span>
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          ...
          {status === "idle" && !existingConnection && (
            <>
              <p className="text-sm text-muted-foreground">
                Connect Health Connect to earn rewards for your fitness data.
              </p>
              ...
              <Button onClick={handleRequest} className="w-full" disabled={!userId || !isAvailable}>
          ...
          {status === "permissions-sent" && (
            <div className="space-y-4 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Grant Life by IDIA access in Health Connect, then tap below.
              </p>
              <Button onClick={handleSync} className="w-full">
                I've Granted Permissions — Sync Data
              </Button>
              <Button variant="outline" onClick={handleRequest} className="w-full">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Card>
                  <CardContent className="p-3 text-center">
                    ...
                    <div className="text-lg font-bold">{lastSync.data.steps?.toLocaleString() || "0"}</div>
                ...
                <Card>
                  <CardContent className="p-3 text-center">
                    ...
                    <div className="text-lg font-bold">{lastSync.data.heartRate || "--"}</div>

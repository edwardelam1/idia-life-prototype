-- Step 1: Clean up duplicate and problematic triggers
...
-- Drop the problematic trigger function that creates circular processing
DROP FUNCTION IF EXISTS public.process_health_metrics();
